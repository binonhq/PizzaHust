...
export default function CartPage() {
  ...
  let totalPrice = 0;
  let feePrice = cart.length ? 10000 : 0;
  let totalDish = 0;
  cart.map((item) => {
  ...
  function removeAllItem(ev) {
    setCart([]);
  }

  return (
    <div className="xl:w-1/2 w-full mx-auto xl:p-0 px-10 mt-8 mb-12 flex flex-col bg-stone-900 py-5 rounded-3xl">
      {!cart.length && (
      ...
      <div className="flex justify-center gap-5">
        ...
        <div
          ...
          className="cursor-pointer my-1 px-5 py-1 font-semibold text-sm rounded-full text-white  bg-stone-700 flex gap-2 hover:bg-gradient-to-r transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none"
        >
          Remove all
        </div>
      </div>
      <div className="w-auto my-5 mb-5 px-5 py-3 mx-20 rounded-xl bg-stone-800 ">
      ...
      <div className="flex justify-between mx-16 text-stone-400">
      ...
      <div className="flex font-semibold mt-3 justify-between mx-16 text-2xl text-stone-400">
        <h1>Total</h1>
        <h1>
